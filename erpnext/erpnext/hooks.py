...
app_logo_url = "/assets/erpnext/images/OMEX.png"
app_home = "/app"

add_to_apps_screen = [
	{
		"name": app_name,
		"logo": "/assets/erpnext/images/OMEX.png",
		"title": app_title,
		"route": app_home,
...
app_include_js = [
	"erpnext.bundle.js",
	"/assets/erpnext/js/pwa.js",
	"/assets/erpnext/js/mobile_redirect_fix.js"
]
app_include_css = [
	"erpnext.bundle.css",
	"/assets/erpnext/css/full_width_layout.css"
]
...
website_context = {
	"favicon": "/assets/omex-favicon.svg",
	"splash_image": "/assets/erpnext/images/OMEX.png",
}
