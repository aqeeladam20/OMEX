...
default_mail_footer = """<div style="padding: 7px; text-align: right; color: #888"><small>Sent via
	<a style="color: #888" href="http://frappe.io/erpnext">OMEX ERP</a></div>"""
...
def check_setup_wizard_not_completed():
	if cint(frappe.db.get_single_value("System Settings", "setup_complete") or 0):
		message = """OMEX ERP can only be installed on a fresh site where the setup wizard is not completed.
...
def add_standard_navbar_items():
	...
	erpnext_navbar_items = [
		# Removed external links to frappe.io and other external sites
		# Only keeping internal functionality
	]
...
def add_app_name():
	frappe.db.set_single_value("System Settings", "app_name", "OMEX ERP")
