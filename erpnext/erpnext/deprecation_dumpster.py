...
This file is the final resting place (or should we say, "retirement home"?) for all the deprecated functions and methods of the OMEX ERP app. It's like a code nursing home, but with more monkey-patching and less bingo.
...
2. The OMEX ERP version at the beginning of which it becomes an error and at the end of which it will be removed (its "graduation" to the great codebase in the sky)
